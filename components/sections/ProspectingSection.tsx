...
const SAMPLE_ITEMS = [
  {
    ...
    video:
      "https://storage.googleapis.com/msgsndr/TT6h28gNIZXvItU0Dzmk/media/67d1d057a50ee1ce3b7474ee.mp4"
  },
  {
    ...
    video:
      "https://storage.googleapis.com/msgsndr/TT6h28gNIZXvItU0Dzmk/media/67d1d0573d10882a1be1713b.mp4"
  },
  {
    ...
    video:
      "https://storage.googleapis.com/msgsndr/TT6h28gNIZXvItU0Dzmk/media/67d1d0575e098b2e1063b246.mp4"
  },
  {
    ...
    video:
      "https://storage.googleapis.com/msgsndr/TT6h28gNIZXvItU0Dzmk/media/67d1d0575e098b2d1e63b247.mp4"
  },
  {
  ...
  },
  {
    ...
    video:
      "https://storage.googleapis.com/msgsndr/TT6h28gNIZXvItU0Dzmk/media/67d1d0576028548dffbd5a3a.mp4"
  }
];
          ...
          if (parts.length >= 3) {
            return (
              <div key={index} className="mb-3 text-left">
                <p>
                  <strong className="font-bold">{parts[1]}</strong>
                </p>
                <p>{parts[2]}</p>
              </div>
            );
...
const CONTACT_FEATURES = [
  {
    ...
    description:
      "Find direct emails for key decision-makers at organizations you want to speak for.",
    video:
  ...
  },
  {
    title: "Event Emails",
    description:
      "Get access to validated event and conference email addresses for easier outreach.",
    video:
  ...
  },
  {
    title: "Event URLs",
    description:
      "Find direct links to application forms and speaker submission portals.",
    video:
      ...
      <div className="container mx-auto max-w-5xl px-6 mb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-14 mx-auto overflow-visible">
          {SAMPLE_ITEMS.map((item, index) => (
            ...
            >
              <MorphingDialogTrigger className="group relative cursor-pointer rounded-lg bg-white transition-all duration-300">
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
        >
          Professionals who speak, train, and consult who want to take control of
