      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Here's your strategic intelligence on this high-value opportunity
          </p>
        </div>
        ...
        >
          ...
          <p className="mb-6 opacity-90">
            Join speakers using SpeakerDrive to book premium engagements
          </p>
        ...
        >
          ...
          <div className="relative w-full max-w-2xl mx-auto aspect-video rounded-xl overflow-hidden shadow-lg">
            <iframe 
              src="https://www.youtube.com/embed/bQYwZYRS9Z4?si=td4rzZ71C9xGALjG" 
              title="SpeakerDrive Demo" 
