  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        {/* CTA Button */}
        <Link
          href={plan.ctaLink || "https://app.speakerdrive.com/signup"}
              ...
              content={[
                {
                  ...
                  content:
                    "The free trial includes up to 10 unlocks. You can search for opportunities, unlock contact information, and use our AI-powered outreach tools with no restrictions.",
                },
                {
                ...
                },
                {
                  ...
                  value: "lead-limit",
                  content:
                    "When you reach your monthly lead limit, you can upgrade to a higher tier plan to access more leads, or wait until your next billing cycle when your lead count resets.",
                },
                {
                ...
                },
                {
                  ...
                  value: "team-pricing",
                  content:
                    "Yes, we offer custom plans if you need more leads. Agencies can also get custom pricing - contact us to discuss your needs.",
                },
              ]}
            />
          </div>
