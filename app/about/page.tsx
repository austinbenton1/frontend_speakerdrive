        ...
        >
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-10">
              {/* Left Card */}
              <div className="bg-white p-6 rounded-xl shadow-md border border-[#e5e5e5] hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] relative group">
